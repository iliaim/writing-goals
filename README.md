...
unrelated skills and agents. The read-only `--status` mode reports whether each local target is
missing, a copy, or a symlink, followed by the newest repository-local archive.
