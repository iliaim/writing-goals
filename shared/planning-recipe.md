...
An activatable successor revision is a complete, self-contained canonical plan: it binds every retained goal and the complete frozen execution order through its own manifest. A narrow correction to an already completed revision is untrusted evidence only; it must not claim activation or terminal/release authority. This prevents a partial patch from silently becoming a second plan.
